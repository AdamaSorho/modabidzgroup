    ...
    <div class="dashboard-content">
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12">
                <form role="form" method="post" action="{{ route("admin.quality.store") }}">
                    @csrf
                    ...
                    <div id="add-listing">
                        ...
                        <div class="add-listing-section">
                            ...
                            <div class="add-listing-headline">
                                <h3><i class="sl sl-icon-map"></i> Ajouter une qualité</h3>
                            </div>
                            ...
                            <div class="submit-section">
                                ...
                                <div class="row with-forms">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="wording_fr" id="wording_fr" value="{{ $quality->getTranslation("wording", "fr") }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="wording_en" id="wording_en" value="{{ $quality->getTranslation("wording", "en") }}">
