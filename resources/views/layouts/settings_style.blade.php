...
*/
    ...
    *::after {
    ...
    .bg-primary {
        background-color: {{ session("setting")->header_color ?? '#000000' }} !important;
    }
    ...
    .bg-secondary {
        background-color: {{ session("setting")->footer_color ?? "#ff0100" }} !important;
    }
    ...
    .text-primary {
        color: {{ session("setting")->header_color ?? '#000000' }} !important;
    }
    ...
    .text-secondary {
        color: {{ session("setting")->footer_color ?? "#ff0100" }} !important;
    }
    ...
    .nav-bar::before {
        ...
        top: 0;
        left: 0;
        background: {{ session('setting')->header_color ?? '#000000' }};
    }
